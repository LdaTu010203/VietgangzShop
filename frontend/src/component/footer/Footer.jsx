        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Chúng tôi mang đến những sản phẩm thời trang chất lượng cao, theo
              xu hướng mới nhất để tôn lên phong cách của bạn.
            </p>
            <div className="flex space-x-4">
              <Link
                to="https://www.facebook.com/groups/vietgangz"
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center space-x-2">
                <FaMapMarkerAlt />
                <span>29 Str 19/5, Ward 1 - Dist 2 Tra Vinh</span>
              </li>
              <li className="flex items-center space-x-2">
                <FaPhone />
                <span>+84 829 900 440</span>
              </li>
              <li className="flex items-center space-x-2">
                <FaEnvelope />
                <span>ceo@vietgangz.com</span>
              </li>
            </ul>
          </div>
