        ...
        if (response.products && response.products.length > 0) {
          ...
          const productMessages = response.products.map((product) => ({
            ...
            content: (
              <div
                key={product.id}
                className="flex gap-3 mb-4 p-3 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                ...
                <div className="flex flex-col">
                  ...
                  <button
                    onClick={() =>
                      navigate(`/directory/product-detail/${product.id}`)
                    }
            ...
            content: (
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <button
                    onClick={() =>
                      navigate(`/directory/fashion-blog/${blog.id}`)
                    }
    ...
    <div className="fixed bottom-5 right-5 z-50">
      {!isOpen && (
        <button
          ...
          className="bg-gradient-to-r bg-black text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all animate-pulse"
        >
      ...
      {isOpen && (
        <div className="bg-white rounded-2xl shadow-xl w-[90vw] max-w-[420px] h-[80vh] max-h-[600px] flex flex-col overflow-hidden transition-all duration-300">
          {/* Header */}
          <div className="p-4 bg-gradient-to-r bg-black flex justify-between items-center">
          ...
          >
            ...
            {messages.map((msg) => (
              ...
              >
                ...
                <div
                  className={`rounded-xl p-3 shadow-sm max-w-[75%] ${
                    msg.sender === "user"
                      ? "bg-indigo-100 text-indigo-900"
                      : "bg-white text-gray-800"
                  }`}
                >
                  {msg.type === "product" || msg.type === "blog"
                    ? msg.content
                    : msg.text}
                </div>
              </div>
