...
const LoginPage = () => {
  ...
  const validateField = (name, value) => {
    ...
    if (name === "password")
      return value.length >= 8 ? "" : "Mật khẩu phải dài ít nhất 6 ký tự";
    return "";
  };
        ...
        <div className="max-w-4xl w-full flex rounded-2xl shadow-2xl overflow-hidden bg-white relative z-10">
          ...
          >
            <div className="h-full w-full bg-blue-500 bg-opacity-20 backdrop-blur-sm flex items-center justify-center">
              ...
              >
                <h2 className="text-4xl font-bold mb-4">Chào mừng Homie!</h2>
                <p className="text-lg">Rất vui được gặp lại</p>
              </motion.div>
            </div>
          </div>
