...
const RegisterPage = () => {
  ...
  return (
    <div>
      ...
      <div className="min-h-screen  bg-gradient-to-br  from-white via-gray-500 to-black flex items-center justify-center p-4">
        ...
        <div className="max-w-6xl w-full  flex rounded-2xl shadow-2xl overflow-hidden bg-white relative z-10">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('https://tse3.mm.bing.net/th/id/OIP.blW09QxH7-wE8pFFr8rvpAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3')`,
            }}
          >
                ...
                <motion.div whileHover={{ scale: 1.01 }} className="group">
                  ...
                  <motion.p
                    ...
                    animate={{
                      ...
                      minHeight: errors.phone ? "20px" : 0,
                      height: errors.phone ? "auto" : 0,
                    }}
                    transition={{ duration: 0.3, ease: "easeInOut" }}
                  >
                    {errors.phone}
              ...
              <motion.div whileHover={{ scale: 1.01 }} className="group">
                ...
                <motion.p
                  ...
                  animate={{
                    ...
                    minHeight: errors.password ? "20px" : 0,
              ...
              <motion.div whileHover={{ scale: 1.01 }} className="group">
                ...
                <motion.p
                  ...
                  animate={{
                    ...
                    minHeight: errors.confirmPassword ? "20px" : 0,
                    height: errors.confirmPassword ? "auto" : 0,
                  }}
                  transition={{ duration: 0.3, ease: "easeInOut" }}
                >
